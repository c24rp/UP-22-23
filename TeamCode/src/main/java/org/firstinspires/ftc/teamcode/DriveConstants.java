...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = .009;
    public static double kA = .00035;
    ...
    public static double MAX_ANG_VEL_DEG = 240;
    public static double MAX_ANG_VEL = Math.toRadians(MAX_ANG_VEL_DEG);
